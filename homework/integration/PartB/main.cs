...
public static void Main(){
	...
	ncalls = 0;	var result_wo_trans = integrate.integrator(f,0,1); 
	WriteLine($"Result without transformation {result_wo_trans}. Called {ncalls}");
	ncalls = 0;	var result_w_trans = integrate.ClenshawCurtisTransformation(f,0,1);
	...
	ncalls = 0; var result_wo_trans2 = integrate.integrator(f,0,1); 
	WriteLine($"Result without transformation {result_wo_trans2}. Called {ncalls}");
	ncalls = 0; var result_w_trans2 = integrate.ClenshawCurtisTransformation(f,0,1);
