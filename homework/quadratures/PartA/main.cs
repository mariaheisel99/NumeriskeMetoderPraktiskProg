...
public static void Main(){
	...
	WriteLine($"Test result of (exact = {exact1}): {complex.approx(exact1,result1,1e-6,1e-6)}");
	...
	WriteLine($"Test result of (exact = {exact2}): {complex.approx(exact2,result2,1e-6,1e-6)}");
	...
	WriteLine($"Test result of (exact = {exact3}): {complex.approx(exact3,result3,1e-6,1e-6)}");
	...
	WriteLine($"Test result of (exact = {exact4}): {complex.approx(exact4,result4,1e-6,1e-6)}");
