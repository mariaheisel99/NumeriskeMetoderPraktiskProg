...
public class main{ 
	public static void Main(){
		...
		var detA = QRGS.det(R2);
		WriteLine($"\n The determinant of A is given to det(A)={detA}");		
		WriteLine("\nPart C");
		WriteLine("Part C is also calculated for operations count, this is performed inside the Makefile and the result are plotted on TimeQRGS.svg. A fit to data is performed with N^3");
	}//Main	
}//classmain
